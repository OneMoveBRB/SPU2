...
source="g++ main.cpp spu_alloc.cpp spu_launch.cpp spu_funcs.cpp ../buffer/buffer_alloc.cpp ../buffer/buffer_funcs.cpp  ../stack/stack_alloc.cpp ../stack/stack_funcs.cpp ../stack/stack_protection.cpp ../stack/utils.cpp -o SPU"
